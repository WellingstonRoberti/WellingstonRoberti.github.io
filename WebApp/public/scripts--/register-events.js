...
export function registerOrientation(videoPlayer, playerElement){

  playerElement.addEventListener("deviceorientation", handleOrientation, true);
  ...
  function handleOrientation(event) {
    ...
    data.setUint8(0, InputEvent.Orientarion);
    data.setFloat32(1, alpha, true);
    data.setFloat32(5, beta, true);
    data.setFloat32(9, gamma, true);
    videoPlayer && videoPlayer.sendMsg(data.buffer);
  }
